...
const translations = {
  en: {
    ...
    '.services-heading .eyebrow': '<span class="eyebrow-line"></span> What we do', '.services-heading h2': 'Give guests a reason<br>to say <em>“let’s go.”</em>', '.process-heading .eyebrow': '<span class="eyebrow-line"></span> A clear process', '.process-heading h2': 'From first idea<br>to <em>final frame.</em>', '.process-card:nth-child(1) h3': 'Tell us the story', '.process-card:nth-child(2) h3': 'We shape the shot', '.process-card:nth-child(3) h3': 'You get the keys', '.process-card:nth-child(1) p': 'Share your property, your goals and the feeling you want guests to take away.', '.process-card:nth-child(2) p': 'We plan the light, angles and deliverables around the way your guests book.', '.process-card:nth-child(3) p': 'Polished, ready-to-publish content that works across your website and booking channels.', '.services-cta span': 'Ready to make your property stand out?', '.services-cta a': 'Book a shoot <span>↗</span>',
  ...
  sl: {
    ...
    '.services-heading .eyebrow': '<span class="eyebrow-line"></span> Kaj ponujamo', '.services-heading h2': 'Gostom dajmo razlog,<br>da rečejo <em>»gremo«.</em>', '.process-heading .eyebrow': '<span class="eyebrow-line"></span> Jasen proces', '.process-heading h2': 'Od prve ideje<br>do <em>končnega kadra.</em>', '.process-card:nth-child(1) h3': 'Povejte nam svojo zgodbo', '.process-card:nth-child(2) h3': 'Oblikujemo kader', '.process-card:nth-child(3) h3': 'Prejmete vse ključe', '.process-card:nth-child(1) p': 'Povejte nam o vašem objektu, ciljih in občutku, ki ga želite ustvariti pri gostih.', '.process-card:nth-child(2) p': 'Svetlobo, kote in končne materiale načrtujemo glede na način, kako vaši gostje rezervirajo.', '.process-card:nth-child(3) p': 'Izpiljena vsebina, pripravljena za objavo na vaši spletni strani in prodajnih kanalih.', '.service:nth-child(1) p': 'Naj bodo sobe, apartmaji in skupni prostori dostopni bodočim gostom še pred prihodom. Gladki virtualni ogledi spremenijo radovednost v zaupanje.', '.service:nth-child(2) p': 'Vrhunske fotografije z občutkom za toplino, podrobnosti in vzdušje vašega objekta — pripravljene za vse prodajne kanale.', '.service:nth-child(3) p': 'Pokažite okolico, razsežnost in občutek kraja. Filmski posnetki iz zraka, ki vaši destinaciji dajo uvodni prizor, ki si ga zasluži.', '.services-cta span': 'Ste pripravljeni izstopati?', '.services-cta a': 'Rezerviraj snemanje <span>↗</span>',
...
const revealItems = document.querySelectorAll('.section-intro, .services-heading, .process-heading, .process-card, .service, .work-card, .tour-copy, .tour-frame, .statement-inner, .contact-copy, .contact-form');
