...
const translations = {
  en: {
    ...
    '.trust-row p': 'Trusted to tell the story of', '.work .eyebrow': '<span class="eyebrow-line"></span> Selected work', '.work h2': 'Spaces that feel like<br><em>somewhere else.</em>', '.section-intro>p:last-of-type': 'From the first impression to the final detail, we make every frame do more work for your brand.', '.work .section-cta .button': 'Get a project quote <span>↗</span>', '.work .section-cta .text-link': 'See a real 360 tour <span>↓</span>',
  ...
  sl: {
    ...
    '.trust-row p': 'Zgodbe pripovedujemo za', '.work .eyebrow': '<span class="eyebrow-line"></span> Izbrani projekti', '.work h2': 'Prostori, ki vas<br><em>odpeljejo drugam.</em>', '.section-intro>p:last-of-type': 'Od prvega vtisa do zadnje podrobnosti poskrbimo, da vsak kader dela za vašo blagovno znamko.', '.work .section-cta .button': 'Pridobi ponudbo <span>↗</span>', '.work .section-cta .text-link': 'Oglej si 360° ogled <span>↓</span>',
...
const copyButton = document.querySelector('.console-copy');
copyButton?.addEventListener('click', async () => {
  try { await navigator.clipboard.writeText('360° virtual tour · Maxis Penthouse'); copyButton.textContent = 'Copied ✓'; setTimeout(() => { copyButton.textContent = 'Copy ↗'; }, 1600); } catch { copyButton.textContent = 'Ready ✓'; }
});
